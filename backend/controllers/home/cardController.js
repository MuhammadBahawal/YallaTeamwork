        ...
        try {
            ...
            if (product) {
                ...
                const product = await cardModel.create({
                    ...
                    quantity,
                    isCoupon,
                    referralBy :customerid ? customerid : null
                })
        ...
        try {
            ...
            for (let i = 0; i < unique.length; i++) {
                ...
                for (let j = 0; j < stockProduct.length; j++) {
                    ...
                    console.log(" stockProduct[j]",  stockProduct[j])
                        ...
                        p[i] = {
                            ...
                            products: p[i] ? [
                                ...p[i].products,
                                {
                                    ...
                                    isCoupon :stockProduct[j].isCoupon,
                                    referralBy :stockProduct[j].customerid
                                }
                            ] : [{
                                _id: stockProduct[j]._id,
                                quantity: stockProduct[j].quantity,
                                productInfo: tempProduct,
                                isCoupon :stockProduct[j].isCoupon,
                                referralBy :stockProduct[j].referralBy
