...
class orderController {
    ...
    place_order = async (req, res) => {
        const {
            price,
            products,
            shippingInfo,  // Expecting shippingInfo to be an object with proper fields like address, city, etc.
            userId
        } = req.body;
        let authorOrderData = [];
        let cardId = [];
        ...
        try {
            const order = await customerOrder.create({
                customerId: userId,
                shippingInfo,  // Store the shipping info object
            ...
            for (let i = 0; i < products.length; i++) {
                ...
                // Assuming shippingInfo is an object with fields like address, city, state, etc.
                authorOrderData.push({
                    ...
                    price: pri,
                    payment_status: 'unpaid',
                    shippingInfo: `${shippingInfo.address}, ${shippingInfo.city}`,  // Format shippingInfo as a string
                    delivery_status: 'pending',
                    date: tempDate
                });
            }
    ...
    order_confirm = async (req, res) => {
        ...
        try {
            ...
            for (let i = 0; i < auOrder.length; i++) {
                const sellerAmount = auOrder[i].price * 0.90;
