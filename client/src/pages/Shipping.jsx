...
const Shipping = () => {
    ...
    const placeOrder = () => {
        ...
        dispatch(place_order({
            ...
            navigate,
            items,
            isReferral :userInfo.isReferral,
            referralBy : userInfo.referralBy
        }))
    }
                                ...
                                <div className="bg-white p-6 shadow-sm rounded-md">
                                    ...
                                    }
                                    {
                                        res && <div className='flex flex-col gap-1'>
                                            ...
                                            <p className='text-slate-600 text-sm'>Email to Yalla7@gmail.com </p>
                                        </div>
                                    }
                                </div>
                                {
                                            ...
                                            p.products.map((pt, j) => <div key={i + 99} className='w-full flex flex-wrap'>
                                                <div className='flex sm:w-full gap-2 w-7/12'>
                                                    <div className='flex gap-2 justify-start items-center'>
                                                        ...
                                                        <div className='pr-4 text-slate-600'>
                                                            ...
                                                            <br/>
                                                             {pt.isCoupon && <span className='text-sm'>Referral will get {pt.productInfo.price * 0.05}</span>}
                                                ...
                                                <div className='flex justify-end w-5/12 sm:w-full sm:mt-3'>
                                                    <div className='pl-4 sm:pl-0'>
                                                        <h2 className='text-lg text-orange-500'>AED{pt.productInfo.price - Math.floor((pt.productInfo.price * pt.productInfo.discount) / 100)}</h2>
                                                        <p className='line-through'>AED {pt.productInfo.price}</p>
