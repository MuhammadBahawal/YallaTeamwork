...
const FeatureProducts = ({ products }) => {
    ...
    return (
        <div className='w-[90%] flex flex-wrap mx-auto'>
            ...
            <div className='w-full grid grid-cols-6 md-lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4'>
                {
                    products.map((p, i) => <div key={i} className='border group transition-all duration-500 hover:shadow-md hover:-mt-3'>
                        <div className='relative overflow-hidden'>
                            ...
                            <img className='sm:w-full w-full h-[190px] ' src={p.images[0]} alt="product image" />
                        ...
                        <div className='py-3 text-slate-600 px-2'>
                            ...
                            <div className='flex justify-start items-center gap-3'>
                                <span className='text-lg  font-bold'>AED {p.price}</span>
                                <div className='flex'>
